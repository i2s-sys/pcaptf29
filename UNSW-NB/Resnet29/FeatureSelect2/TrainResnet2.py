# TensorFlow 2.9.0 compatible second training script for UNSW-NB ResNet
import sys
import time
...
# infs
all_features = [20,21,11,12,6,8,7,29,17,15,18,16,27,26,4,19,22,10,5,9,13,14,1,35,40,30,39,32,33,0,34,2]
...
feature_widths = [
    ...
    32, 32, 32, 32, 32, 32, 32, 32, 1, 32, 32, 32, 32, 1
]
...
if __name__ == '__main__':
    ...
    for epoch in range(TRAIN_EPOCH):
        ...
        if accuracy > best_accuracy:
            ...
            model2.model.save_weights(best_model_path)
    ...
    # 获取验证集最佳模型
    if best_model_path:
        model2.model.load_weights(best_model_path)
