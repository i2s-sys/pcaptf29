# TensorFlow 2.9.0 compatible VGG with configurable loss function (UNSW-NB)
import time
...
class VGG():
    def __init__(self, K, lossType, ES_THRESHOLD, seed, beta, gamma):
        ...
        # Create the model
        self.model = VGGModel(seed=self.seed)
