# TensorFlow 2.9.0 compatible VGG implementation with feature selection
import gc
import time
...
class VGG(Model):
    ...
    def call(self, inputs, training=None):
        ...
        x = tf.reshape(scaled_input, [batch_size, DATA_DIM, 1, 1])
    ...
    def compute_loss(self, y_true, y_pred):
        ...
        if self.lossType == "ce":
            ...
            loss = tf.reduce_mean(cb_focal_loss) + regularization_penalty
