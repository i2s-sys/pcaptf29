...
class LSTM():
    ...
    def create_LSTM(self):
        ...
        lstm_cell = layers.LSTMCell(n_units)
        rnn_layer = layers.RNN(lstm_cell)
        outputs = rnn_layer(x)
        self.y = tf.matmul(outputs, layer['weights']) + layer['bias']
    ...
    def build_loss(self):
            ...
            self.train_op = self.optimizer.apply_gradients(zip(grads_and_vars, [self.scaling_factor]),
